...
- [ ] Fix hex/binary values converting to decimal
- [ ] Fix correction for FlagAttriute enums
  - [ ] Extent highlights the attribute instead of the enum definition
  - [ ] Correction removes the attribute
  - AttributeAst are actually children of TypeDefinitionAst ($ast.Attributes)
...
- [ ] Use rule in VSCodeProfile instead of duplicating work
